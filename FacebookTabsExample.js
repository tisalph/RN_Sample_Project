...
const FacebookTabsExample = React.createClass({
    render() {
        return <View style={styles.container}>
            <Image source={require('./Background.png')} style={styles.image} resizeMode="cover">
             </Image>
                <ScrollableTabView initialPage={0} renderTabBar={() => <FacebookTabBar backgroundColor='rgba(255, 255, 255, 0.7)' />}
                    ...
                    <ScrollView tabLabel="ios-add-circle" style={styles.tabView}>
                        <View style={styles.card}>
                            <Text>Notifications</Text>
                        </View>
                    </ScrollView>
                    <ScrollView tabLabel="ios-map-outline" style={styles.tabView}>
                        <View style={styles.card}>
                            <Text>Other nav</Text>
                        </View>
                    </ScrollView>
